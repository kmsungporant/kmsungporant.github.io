        ...
        <div key={i}>
          {project.direction === "right" ? (
            <div className="relative flex items-center w-[100rem]  justify-start ">
              <div className="absolute right-0 w-[55%] h-full text-right text-dark-primary dark:text-light-primary">
            ...
            <div className="relative flex items-center w-[100rem] justify-end ">
              <div className="absolute left-0 h-full text-left text-dark-primary dark:text-light-primary">
