...
export default function NewCards({ projects, selected }) {
  return (
    <div className="flex flex-col items-center justify-center h-[50em] ">
                      ...
                      {project.link ? (
                        <div className="flex justify-start text-dark-secondary dark:text-light-secondary">
                          <Link href={project.link} passHref>
                            <motion.a
                              target="_blank"
                              className="2xl:text-2xl text-lg flex items-center justify-start w-[20%] gap-4 font-black hover:text-dark-primary hover:dark:text-light-primary "
